...
async function initProductsPage() {
    ...
    // Opcional: Adicionar nome do usuário e gerenciar acesso ao módulo se necessário
    // document.getElementById('user-name').textContent = getUserData()?.nome || 'Utilizador';
