...
// Mesmo padrão usado em produtos.js: cobre todos os links da sidebar do checklist,
// incluindo o estoque (que nenhuma das duas versões duplicadas desta função verificava).
